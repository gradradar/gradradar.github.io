...
CANDIDATES = [
    ...
    # --- UK graduate employers, added for the early-careers push -----------
    "Rentokil Initial", "Compass Group", "Sodexo", "Mitie", "Serco", "Capita",
    "Greggs", "JD Wetherspoon", "Mitchells and Butlers", "Whitbread",
    "Premier Inn", "Travelodge", "IHG", "Accor", "Hilton", "Marriott",
    "Costa Coffee", "Pret a Manger", "Nando's", "Wagamama", "Pizza Express",
    "Five Guys", "Leon", "Itsu", "Honest Burgers", "Franco Manca",
    "Bloomberg", "Thomson Reuters", "Refinitiv", "IHS Markit", "Moody's",
    "S&P Global", "MSCI", "FactSet", "Morningstar", "Preqin", "Dealogic",
    "Man Group", "Marshall Wace", "Winton", "GSA Capital", "Squarepoint",
    "Optiver", "IMC Trading", "Flow Traders", "DRW", "Jane Street", "Citadel",
    "Point72", "Millennium", "Balyasny", "Brevan Howard", "Capula",
    "Monzo", "Starling", "Atom Bank", "Chase UK", "Zopa", "OakNorth",
    "Allica", "Griffin", "ClearBank", "Banked", "TrueLayer", "Yapily",
    "Plaid", "Codat", "Fintech OS", "Thought Machine", "10x Banking",
    "Ocado", "THG", "Moonpig", "Made.com", "Secret Escapes", "On the Beach",
    "Trainline", "Skyscanner", "Booking", "Expedia", "Airbnb", "GetYourGuide",
    "Deliveroo", "Just Eat", "Uber", "Bolt", "Gett", "Zego", "Zipcar",
    "Depop", "Vinted", "Etsy", "eBay", "Zalando", "About You", "Asos",
    "Boohoo", "PrettyLittleThing", "Missguided", "In The Style", "Nobody's Child",
    "Sweaty Betty", "Lululemon", "Nike", "Adidas", "Puma", "New Balance",
    "Unmind", "Spill", "Koa Health", "Babylon", "Push Doctor", "Livi",
    "Peppy", "Bupa", "Vitality", "Simplyhealth", "Benenden",
    "Improbable", "Ultraleap", "Graphcore", "Arm", "Imagination Technologies",
    "Nominet", "Cloudflare", "Fastly", "Akamai", "DigitalOcean", "Linode",
    "Elastic", "MongoDB", "Redis", "Confluent", "Databricks", "Snowflake",
    "Palantir", "Faculty", "Satalia", "Causaly", "BenevolentAI", "Exscientia",
    "DeepMind", "Wayve", "Five AI", "Oxbotica", "Arrival", "Rivian",
    "Octopus Investments", "Downing", "Triodos", "Ecology Building Society",
    "Which", "Citizens Advice", "Cancer Research UK", "Oxfam", "Save the Children",
    "British Red Cross", "WWF", "RSPB", "National Trust", "English Heritage",
    "Teach First", "Ambitious about Autism", "Barnardos", "NSPCC", "Mind",
    "Frontline", "Police Now", "Unlocked Graduates", "Think Ahead",
]
